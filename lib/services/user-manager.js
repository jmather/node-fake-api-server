...
class UserManager {
    ...
    _ensureCleanupStarted() {
        ...
        // console.log('[UserManager._ensureCleanupStarted] turning on user cleanup.');
    ...
    _runCleanup() {
        // console.log('[UserManager._runCleanup] run beginning.');
        ...
        for (const username in this.users) {
            ...
            if (this.users[username].last_active < max_age) {
                // console.log('[UserManager._runCleanup] Purging user ' + username);
        ...
        // console.log('[UserManager._runCleanup] run complete.', { checked, purged });
